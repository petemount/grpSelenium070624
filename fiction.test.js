...
test("scrapen von books to scape by Kategorie Science Fiction", async () => {
  ...
  const mouseClick = await driver.findElement(
    By.xpath('//*[@id="default"]/div/div/div/aside/div[2]/ul/li/ul/li[9]/a')
    // Fiction-x-path: //*[@id="default"]/div/div/div/aside/div[2]/ul/li/ul/li[9]/a
  );
  ...
  for (let book of books) {
    ...
    let prodDescElement = driver.findElement(
      By.css("#product_description ~ p")
    );
