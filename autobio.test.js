...
test("scrapen von books to scape by Kategorie Autobiography", async () => {
    await driver.get("http://books.toscrape.com");

    const mouseClick = await driver.findElement(
        By.xpath('//*[@id="default"]/div/div/div/aside/div[2]/ul/li/ul/li[26]/a')
    );
    ...
    // Hinweis: await driver.navigate().back() --> für den Rücksprung z:B. aus der Detailseite.    
});